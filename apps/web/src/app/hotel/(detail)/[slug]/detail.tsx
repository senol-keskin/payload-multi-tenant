        ...
        <Container className='px-2 py-2'>
          <div className='relative text-xs font-semibold text-blue-800 md:hidden'>
            ...
            <div className='flex items-center gap-2'>
              {/* <input value={JSON.stringify(hotel)} readOnly />   */}
      ...
      >
        <div>
          {hotel?.documents && hotel?.documents?.length > 0 && (
            <div className='pb-3 text-center text-xs md:text-end'>
              <span>
              ...
              <div>
                ...
                {generalInfoContentHeight > GENERAL_INFO_MAX_HEIGHT && (
                  <Button
                    ...
                    className='bg-transparent p-0 text-sm font-medium text-blue-700 md:my-0'
                  >

                    ...
                    <div className='flex flex-col gap-5 rounded-lg border p-5 shadow-sm'>
                      ...
                      <div className='py-4'>
                        <Button
                          ...
                          fullWidth
                          size={
                            calculateTotalPriceQuery.data?.success ? 'lg' : 'xl'
                          }
                          disabled={
                            !calculateTotalPriceQuery.data?.success ||
                        ...
                        >
                          {calculateTotalPriceQuery.isSuccess &&
                          !calculateTotalPriceQuery.data?.success &&
                          !extraServicesMutation.isPending ? (
                            <div className='flex flex-col gap-1 text-sm font-bold text-red-800'>
                              <div>
                                {passengers.adultCount.split(':')[0]} yetişkin{' '}
                                {passengers.childAge?.length &&
                                  ', ' +
                                    passengers.childAge?.length +
                                    ' çocuk'}{' '}
                                için müsaitlik yoktur.
                              </div>
                              <div>

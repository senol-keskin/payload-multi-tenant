...
export const Header = () => {
  ...
  const headerInfoReact = widgets?.data?.find(
    (item) => item.point === 'header_info_react'
  )
  ...
  const [openedHeaderInfo, { toggle }] = useDisclosure(true)
  return (
    <>
      {pathname === '/' && headerInfoReact?.params.description.value && (
        <Collapse
          in={openedHeaderInfo}
          transitionDuration={500}
          transitionTimingFunction='linear'
        >
          <div className='relative flex justify-center bg-blue-100 py-2'>
            <Container className='grid w-full items-center justify-center gap-3 font-medium md:flex'>
              <Link href={headerInfoReact?.params.link.value as Route}>
                <div
                  className='text-center'
                  dangerouslySetInnerHTML={{
                    __html: headerInfoReact?.params.description.value,
                  }}
                />
              </Link>
              <div className='hidden items-center justify-center gap-3 md:flex'>
                <Badge className='bg-orange-800 py-3'>
            ...
            <Button
              onClick={toggle}
              className='rounded-full bg-transparent text-red-800'
            >
              <IoClose size={24} />
            </Button>
          </div>
      ...
      <div className='hidden border-b py-2 md:block'>
